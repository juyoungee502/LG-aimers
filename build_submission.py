...
def main():
    ...
    if args.expected_version in ("v17_trackman_context", "v18_f_regime", "v19_failure_specialist", "v20_residual_portfolio", "v21_robust_residual_portfolio"):
        model_names.extend(
            f"catboost_trackman_context_{index}.cbm" for index in range(3)
        )
    if args.expected_version in ("v18_f_regime", "v19_failure_specialist", "v20_residual_portfolio", "v21_robust_residual_portfolio"):
        model_names.extend(f"catboost_f_regime_{index}.cbm" for index in range(3))
    if args.expected_version in ("v19_failure_specialist", "v20_residual_portfolio", "v21_robust_residual_portfolio"):
        model_names.extend(
    ...
    if args.expected_version in ("v20_residual_portfolio", "v21_robust_residual_portfolio"):
