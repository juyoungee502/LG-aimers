...
REQUIRED_MODELS = ("metadata.json", "lgb_0.txt", "lgb_1.txt", "catboost.cbm")
...
def main():
    ...
    required = [root / "script.py", root / "requirements.txt"] + [root / "model" / n for n in REQUIRED_MODELS]
    ...
    if metadata.get("version") != "v3_rolling_bss_ensemble":
